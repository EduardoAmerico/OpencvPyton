...
cv2.createTrackbar("Sat min", "TrackBars", 38, 255, empty)
...
# cv2.createTrackbar("Sat min", "TrackBars", 28, 255, empty)
# cv2.createTrackbar("Sat max", "TrackBars", 255, 255, empty)
...
while True:
    ...
    imgStakc = stackImages(0.6, ([img, imgHSV], [mask, imgResult]))
    cv2.imshow("Carro stack", imgStakc)
